...
def create_composite_barcode_image():
    iconMap = glob.glob("checkin/static/checkin/tmp/ean8_barcode*.png")
    ...
    master = Image.new(mode='RGBA', size=(master_width, master_height), color=(0, 0, 0, 0))  # fully transparent
    ...
    master.save('checkin/static/checkin/tmp/master.png', 'PNG')
    print("saved!")
